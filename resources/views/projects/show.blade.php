...
@section('title', "porjects | " . $project->title)
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            @auth
                <div class="btn-group btn-group-sm">
                    <a class="btn btn-primary" href="{{ route('project.edit', $project) }}">Edit</a>
                    <a class="btn btn-danger" href="#" onclick="document.getElementById('delete-project').submit()">Delete</a>
                </div>
                <form class="d-none" id="delete-project" action="{{ route("project.destroy", $project) }}" method="post">
                    @csrf @method("DELETE")
                </form>
            @endauth
        </div>
